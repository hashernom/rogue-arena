...
exports.Masks = exports.Groups = void 0;
exports.makeCollisionGroups = makeCollisionGroups;
exports.getMaskForGroup = getMaskForGroup;
exports.setupColliderGroups = setupColliderGroups;
/**
 ...
 */
exports.Masks = {
    PLAYER: exports.Groups.ENEMY | exports.Groups.WALL | exports.Groups.PICKUP,
    ENEMY: exports.Groups.PLAYER | exports.Groups.WALL | exports.Groups.PROJECTILE,
    PROJECTILE: exports.Groups.ENEMY | exports.Groups.WALL,
    WALL: 0xffffffff, // colisiona con todo (máscara de 32 bits)
    PICKUP: exports.Groups.PLAYER,
 ...
 */
function getMaskForGroup(group) {
    return exports.Masks[group];
}
/**
 ...
 */
function setupColliderGroups(colliderDesc, group) {
    const membership = exports.Groups[group];
    const filter = exports.Masks[group];
